...
* Abstract
- Objective :: This study set out to examine preanlytical factors
...
- Design and Methods :: A data mining approach was used to investigate
...
metabolism (Figure [[fig:cycle]]).

Virginia was the first jurisdiction to perform universal newborn
screening for biotinidase deficiency, beginning in 1984
[cite:@Wolf2015a]. Biotinidase deficiency has been a target disorder
for newborn screening in Ontario since 2007 and was added to the
Recommended Universal Screening Panel in the United States in 2006
...
benefit of families and the healthcare system [cite:@Kwon2000]. A
    ...
    // substrate and product nodes
     ...
     // function nodes
	   node [shape=octagon, style=filled, color=whitesmoke];
	      functions[label="Lipid Metabolism\nGluconeogenesis\nAmino Acid Metabolism"];
