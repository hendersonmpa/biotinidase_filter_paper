...
deficiency have 10-30\% of mean normal serum activity (\hyperlink{citeproc_bib_item_10}{Strovel et al. 2017}).
...
\label{sec:orgc780d14}
\subsection*{Observational Study}
\label{sec:org47b5bb1}
...
'decompose' function in R (\hyperlink{citeproc_bib_item_11}{Team 2020}). The times series of weekly
biotinidase activity data (y\textsubscript{t}) was represented as an additive model
(Equation \ref{eq:ts}) The non-linear trend component T\textsubscript{t}, reflects
the long-term progression of the series determined using a moving
average. The seasonal contribution S\textsubscript{t}, was computed by averaging for each
weekly time unit for all 52 week periods. The random component r\textsubscript{t}, was
determined be removing the trend and seasonal components from the
original times series y\textsubscript{t}.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./figures/biotgaltpos.pdf}
...
\label{sec:org100cc08}
Funding: None.
\section*{References}
\label{sec:org86bb159}
