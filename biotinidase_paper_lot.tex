...
metabolism (Figure \ref{fig:orgb2ae503}). Neurological symptoms of biotinidase
...
\caption{\label{fig:orgb2ae503}The Biotin Cycle adapted from (\hyperlink{citeproc_bib_item_10}{Strovel et al. 2017}). Grey ovals contain substrates and products. Labelled black points represent enzymes. Metabolic functions of holocarboxylases are listed in the light grey octagon.}
\end{figure}

\section*{Material and Methods}
\label{sec:orgafb1f6f}
\subsection*{Observational Study}
\label{sec:org4062d93}
...
\section*{Results}
\label{sec:org857bf7e}
\subsection*{Time Series Analysis}
\label{sec:org52eeb85}
...
the warm summer months (Figure \ref{fig:org6e2ce93} and \ref{fig:org9fa5753}). However,
...
zero (Figure \ref{fig:org6e2ce93} between the dashed blue lines). There is no
corresponding change in the galactosemia screen positive rate during
this time period (Figure \ref{fig:org6e2ce93} between the dashed blue lines).

% latex table generated in R 4.0.3 by xtable 1.8-4 package
% Sat Feb 12 10:05:59 2022
\begin{table}[ht]
\centering
\begin{tabular}{rrrrr}
  \hline
...
\caption{\label{fig:org6e2ce93}Time series of weekly screen positive biotinidase deficiency referrals, median weekly biotinidase activity and mean weekly temperature (\degree{}C). Dashed blue lines flank a period with an elevated screen positive rate.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./figures/galtpts.pdf}
\caption{\label{fig:org9fa5753}Time series of weekly screen positive galactosemia referrals, median weekly GALT activity and mean weekly temperature (\degree{}C).  Dashed blue lines flank a period with an elevated screen positive rate.}
\end{figure}

\clearpage

\subsection*{Season and Trend Decomposition}
\label{sec:org6e1f78f}
...
\ref{fig:orgeced6d1}). This analysis revealed a marked seasonal effect with
...
during 2017 and 2018 (Figure \ref{fig:orgeced6d1}). External temperature was
...
\caption{\label{fig:orgeced6d1}Decomposition of the median weekly biotinidiase activity time series into seasonal, random and trend components.}
\end{figure}

\clearpage

\subsection*{Biotinidase Activity by Filter Paper Lot}
\label{sec:orgfbae25a}
...
paper lots over four years (Figure \ref{fig:orgb960e97}). Due to a time sensitive
...
(Figure \ref{fig:orgb960e97}, purple line and Table \ref{tab:w161_months}).

\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./figures/biotform.pdf}
\caption{\label{fig:orgb960e97}Median weekly biotinidase activity by filter paper collection card lot. Each lot of filter paper is plotted independently and indicated with a distinct colour.}
\end{figure}

\clearpage

% latex table generated in R 4.0.3 by xtable 1.8-4 package
% Sat Feb 12 10:06:05 2022
\begin{table}[ht]
\centering
\begin{tabular}{lrrrr}
  \hline
...
\label{sec:org508a711}
Based on the observed inhibition of biotinidase activity with filter
paper lot W161 (Figure \ref{fig:orgb960e97}, purple line and Table
...
\ref{fig:orgfb3f288}). Inhibition of biotindase activity by filter paper lot W171
...
\caption{\label{fig:orgfb3f288}Comparison of biotinidase activity (MRU) in samples spotted simultaneously onto filter paper lots w152, w161, w162, w171 at Time 0. linear regression- blue, line of identity- red}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./figures/demingw171.pdf}
\caption{\label{fig:orge20ba89}Biotinidase activity (MRU) in samples spotted onto filter paper lot W152 v W171 with Deming regression at time 0.}
\end{figure}
\clearpage
...
\caption{\label{fig:org91ac109}Comparison of biotinidase activity (MRU) in samples spotted simultaneously onto filter paper lots w152, w161, w162, w171 at Time 0 + 2 months. linear regression- blue, line of identity- red}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./figures/demingw171_2.pdf}
\caption{\label{fig:org29d981c}Biotinidase activity (MRU) in samples spotted onto filter paper lot W152 v W171 with Deming regression at time 0 + 2 months.}
\end{figure}

\clearpage

\section*{Discussion}
\label{sec:orgca2cdc2}
...
\label{sec:org8641ddc}
Funding: None.
\section*{References}
\label{sec:org4e456b7}
